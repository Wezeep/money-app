...
type PeerToPeerTransferScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'PeerToPeerTransfer'
>;

interface Props {
  navigation: PeerToPeerTransferScreenNavigationProp;
}

const { width } = Dimensions.get('window');

const PeerToPeerTransferScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleTransfer = (): void => {
    ...
    Alert.alert('Success', `Transfer of $${amount} sent to ${selectedContact.name}!`);
    navigation.goBack();
  };
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Choose a contact to send money to</Text>
        </View>
        ...
        {/* Transfer Form */}
        {selectedContact && (
          <Surface style={styles.transferCard} elevation={4}>
            <LinearGradient
...
export default PeerToPeerTransferScreen;