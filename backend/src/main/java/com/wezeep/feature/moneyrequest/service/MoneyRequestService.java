package com.wezeep.feature.moneyrequest.service;
...
public class MoneyRequestService {
    ...
    public MoneyRequestResponse create(UUID requesterId, CreateMoneyRequestRequest dto) {
        ...
        UUID recipientId = resolveRecipientUserId(dto);
    ...
    private UUID resolveRecipientUserId(CreateMoneyRequestRequest dto) {
        ...
        if (dto.getRecipientWezeepId() != null && !dto.getRecipientWezeepId().isBlank()) {
            return userRepository.findByWezeepId(dto.getRecipientWezeepId())
